...
/*
Crie uma classe LinguagemFavorita que possua os atribtos nome, anoDeCriacao e IDE.
...
public class ExercicioLinguagensProgramacao {
    public static void main(String[] args) {
        ...
        minhasLinguagensFavoritas.add(new LinguagemFavorita("JavaScript", 1995, "InteliJ"));
